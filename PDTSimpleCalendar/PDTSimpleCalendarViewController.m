...
@property (nonatomic, strong) CalendarHeaderView                 * weekcollectionView;
...
- (void)viewDidLoad
{
    ...
    NSInteger weekdayHeaderHeight = self.weekdayHeaderEnabled ? PDTSimpleCalendarWeekdayHeaderHeight : 30;
...
-(CalendarHeaderView *)weekcollectionView{
    if (_weekcollectionView == nil) {
        _weekcollectionView = [[CalendarHeaderView alloc]initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 30)];
    }
